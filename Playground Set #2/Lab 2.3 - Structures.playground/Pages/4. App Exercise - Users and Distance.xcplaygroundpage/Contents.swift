 ...
 */
let jonathan = User(name: "Jonathan", age: 21, height: 62, weight: 170.4, activityLevel: 6)
print("Name: \(jonathan.name) Age: \(jonathan.age) Height: \(jonathan.height) Weight: \(jonathan.weight) Activity: \(jonathan.activityLevel)")
/*:
