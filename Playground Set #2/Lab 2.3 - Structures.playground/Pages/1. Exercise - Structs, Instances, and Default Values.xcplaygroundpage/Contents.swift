...
favoriteBook.title = "flowers for algernon"
favoriteBook.author = "daniel keyes"
favoriteBook.pages = 311
favoriteBook.price = 14.99

print("My favorite book is \(favoriteBook.title), by \(favoriteBook.author). It is \(favoriteBook.pages) long, and costs $\(favoriteBook.price)")
