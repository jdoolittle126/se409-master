...
func add(num1: Int?, num2: Int?) -> Int? {
    guard let first = num1, let second = num2 else {
        return nil
    }
    return first + second
}

print(add(num1: 5, num2: 5))
print(add(num1: 4, num2: nil))
/*:
 ...
 */
let jonathan = createUser()

if let user = jonathan {
